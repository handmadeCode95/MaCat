...
<html lang="ko">
    ...
    <body>
								...
								<div>
									...
									<div class="title_price_container">
										...
										<div class="price">
											...
											<p><fmt:formatNumber value="${i.prduct_price}" pattern="#,###"></fmt:formatNumber>원</p>
											<!--가격 위치조절용 div-->
											<div class="space"></div>
										</div>
									</div>
        ...
        <!--top 버튼-->
        <div class="top_button"><a href=""><img src="resources/img/top_button.png" alt=""></a></div>
        <!-- 플로팅 메뉴 : 리모콘-->
