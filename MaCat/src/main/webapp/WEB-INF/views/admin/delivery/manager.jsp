...
<html lang="ko">
	...
	<head>
	    ...
	    <link rel="stylesheet" href="resources/css/admin/radiobutton.css">
   	    <!-- 관리자페이지 css -->
	    <link rel="stylesheet" href="resources/css/admin/delivery/manager.css">
	    <!-- 관리자 테이블 css-->
	    <link rel="stylesheet" href="resources/css/admin/delivery/admin_table.css">
	    <!--input text입력창 조절 css-->
	    <link rel="stylesheet" href="resources/css/admin/delivery/input_textarea.css">

	    <!-- 스크립트 -->
	    <script type="text/javascript" src="resources/js/jquery-3.4.1.min.js"></script>	    

	    <!-- 관리자 쿼리  -->
	    <script type="text/javascript" src="resources/js/admin/delivery/manager.js"></script>
	    <!-- checkbox 전체선택 쿼리 포함 -->
