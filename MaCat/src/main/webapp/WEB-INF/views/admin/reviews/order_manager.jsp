...
<html lang="ko">
	<head>
	    ...
	    <!-- 관리자페이지 css -->
	    <link rel="stylesheet" href="resources/css/admin/order/manager.css">
	    <!-- 관리자 테이블 css-->
	    <link rel="stylesheet" href="resources/css/admin/order/admin_table.css">
	    <!--input text입력창 조절 css-->
	    <link rel="stylesheet" href="resources/css/admin/order/input_textarea.css">
  
	    <script type="text/javascript" src="resources/js/jquery-3.4.1.min.js"></script>	    	    
	    <script type="text/javascript" src="resources/js/admin/order/manager.js"></script>
	    <!-- checkbox 전체선택 쿼리 포함 -->
	...
	<body>
	    ...
	    <main>
	        <section class="wrap">
	            ...
	            <form id="searchForm" action="order_search.mcat" method="post">
