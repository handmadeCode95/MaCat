...
public class ProductsVO {
	...
	public ProductsVO(String prduct_sq, String prduct_reg_dt, String prduct_dom_dt, String prduct_amt,
			...
			String ctgry_nm, String prduct_cd, float prduct_rating_avg, int prduct_ctgry_group, int prduct_rating_round,
			int prduct_price, int prduct_dlvy_price, int prduct_point, int prduct_dced_price, int prduct_save_pt,
			int prduct_save, int prduct_dc_pt, int prduct_dc) {
		super();
