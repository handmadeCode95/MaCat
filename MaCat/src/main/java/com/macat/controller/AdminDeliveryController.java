...
import com.macat.dto.DeliveryAddrSearchDTO;
...
public class AdminDeliveryController {
	...
	private DeliverySearchDTO deliverySearchDTO; // 페이징을 위한 정보 검색 기록
	private DeliveryAddrSearchDTO deliveryAddrSearchDTO; 
